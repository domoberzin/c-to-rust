...
if ! ../csplit infile --definitely-invalid 2>/dev/null; then
    echo "Test 10 PASSED"
fi
...
if ! ../csplit -f "output_file_prefix" -n 19 infile "%pattern%" "{*}" 2>/dev/null; then
    echo "Test 18 PASSED"
else
    echo "Test 18 FAILED"
fi
...
if ../csplit -f custom_prefix infile 2 > /dev/null; then
...
if ! ../csplit -k infile /NoMatch/ 2>/dev/null; then
...
if ! ../csplit -n 1000000000000000000000 infile 3 2>/dev/null; then
    echo "Test 23 PASSED"
else
    echo "Test 23 FAILED"
fi
...
# Test too long name
if ! ../csplit -n 100000000000000 infile 3 2>/dev/null; then
    echo "Test 24 PASSED"
else
    echo "Test 24 FAILED"
fi
...
if ! ../csplit -z infile 3 2>/dev/null; then
    echo "Test 25 PASSED"
else
    echo "Test 25 FAILED"
fi
...
if ! ../csplit non_existent_file 2 2>/dev/null; then
    echo "Test 27 PASSED"
else
    echo "Test 27 FAILED"
fi
...
if ! ../csplit -f="$long_prefix" infile 2>/dev/null; then
    echo "Test 28 PASSED"
else
    echo "Test 28 FAILED"
fi
...
# Trigger overflow
if ! ../csplit infile 1000000000000000000000 2>/dev/null; then
    echo "Test 29 PASSED"
else
    echo "Test 29 FAILED"
fi
...
if ! ../csplit infile /Line\ 2 2>/dev/null; then
    echo "Test 30 PASSED"
else
    echo "Test 30 FAILED"
fi
...
if ! ../csplit infile -1 2>/dev/null; then
    echo "Test 33 PASSED"
else
    echo "Test 33 FAILED"
fi
